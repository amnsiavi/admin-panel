...
export default function AdminPanel() {
  ...
  const drawer = (
    <div style={darkMode ? {
      ...
      <List>
          <ListItem  disablePadding sx={{ marginBottom: '40px' }}>
            <ListItemButton sx={{cursor:'pointer'}} onClick={()=>{
              navigate('/addAdmin')
            }}>
              <ListItemIcon>
                 {users['User']}
              </ListItemIcon>
              <ListItemText primary='Add User' sx={darkMode ? {color:'#fff', fontWeight:600}:{fontWeight:600}} />
            </ListItemButton>
          ...
          <ListItem  disablePadding sx={{ marginBottom: '40px' }}>
            <ListItemButton sx={{cursor:'pointer'}}>
              ...
              <ListItemText primary='Edit User' sx={darkMode ? {color:'#fff',fontWeight:600}:{fontWeight:600}} />
            </ListItemButton>
          ...
          <ListItem  disablePadding sx={{ marginBottom: '40px' }}>
            <ListItemButton sx={{cursor:'pointer'}}>
              ...
              <ListItemText primary='Ban User' sx={darkMode ? {color:'#fff',fontWeight:600}:{fontWeight:600}} />
            </ListItemButton>
  ...
  return (
    ...
    <Box sx={{ display: 'flex', }}>
      ...
      >
        <Toolbar />
        {
            data?.apiData ?  <DataTable darkMode={darkMode} data={data.apiData} setId={setID} handleOpen={handleDeleteModalOpen}/>: null
        }
      </Box>
    </Box>
    </>
